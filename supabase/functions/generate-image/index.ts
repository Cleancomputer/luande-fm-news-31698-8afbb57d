    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "user",
            content: `Crie uma imagem no estilo jornalístico profissional para um portal de notícias. ${prompt}. A imagem deve ter proporção 16:9 e ser adequada para um card de notícia.`
          }
        ],
